...
class Post(models.Model):
    ...
    category = models.ForeignKey(Category, blank=False, on_delete=CASCADE)
    likes = models.ManyToManyField(User, on_delete=CASCADE, blank=True, related_name='users_likes_it')
